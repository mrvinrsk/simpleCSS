        ...
        <div class="docu-element" data-docu-title="Alert"
            ...
            <div class="example">
                ...
                <div class="alert-success" data-alert-autoclose="10000">
                    <i class="bi bi-info-circle-fill"></i>
                    <p>This alert will dismiss automatically after 10.000ms.</p>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.querySelectorAll('div.docu-element').forEach(function (docuelement) {
        ...
        docuelement.innerHTML = '<div><h1 class="fc-main fw-bold fsi-xl"><a href="#' + id + '" class="fc-gray-dark" style="font-size: inherit;">#</a> ' + docuelement.dataset.docuTitle + '</h1>' + '<p>' + docuelement.dataset.docuDescription + '</p></div><div><p class="fc-main-lightest fsi-large fw-semibold mb-1">Example</p>' + docuelement.innerHTML + '</div>';
        ...
        /* Add Example Code */
        docuelement.innerHTML += "<div><p class='fc-main-lightest fsi-large fw-semibold mb-1'>Code</p><div class='code'><i class='fas fa-copy copy fc-white-darker'></i><pre><code class='language-html sc'>" + docuelement.querySelector('.example').innerHTML.replaceAll('<', '&lt;').replaceAll('>', '&gt;') + "</code></pre></div></div>";
